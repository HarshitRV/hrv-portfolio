		...
		<div
			...
			<div className="card-project-type-stack">
				<span
					...
					style={props.project.color}>
					{props.project.type}
				</span>

				<span className="card-project-stack">{props.project.stack}</span>
			</div>

			<h2 className="card-project-title">{props.project.title}</h2>
